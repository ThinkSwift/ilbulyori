...
function greet() {
  addBubble(
    "jarvis",
    "안녕하세요 사장님! 저는 사장님 대신 이 홈페이지를 꾸며 드리는 비서예요.\n\n우리 이렇게 해봐요 — 사장님이 만드신 요리를 사진으로 하나씩 올려주시면, 제가 예쁜 글로 채워서 이 홈페이지를 함께 완성해 갈게요. 그리고 이 완성돼 가는 홈페이지를 보여드리면서 멘토링을 받는 거예요. 멘토링이 네 번 있으니, 그때마다 조금씩 채워진 모습을 보여드리면 딱이랍니다.\n\n잘 돼서 다음 단계까지 가면 정말 좋고, 혹시 잘 안 돼도 괜찮아요. 제가 계속 열심히 할 거고, 나중에 또 다른 기회가 올 수도 있고, 앱이 인기를 얻게 될 수도 있으니까요. 그러니 부담 갖지 마시고 가볍게 시작해봐요 😊\n\n제일 쉬운 첫걸음 — 오늘 만드신 요리 사진 한 장을 아래 📷 로 올려주세요. 나머지는 제가 다 할게요!"
  );
  addChips([
    "좋아, 요리 사진 올릴게 (📷)",
    "이 홈페이지로 뭘 보여주는 거야?",
