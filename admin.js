...
function greet() {
  addBubble(
    "jarvis",
    "안녕하세요 사장님! 저는 사장님의 홈페이지를 대신 완성해 드리는 비서예요.\n\n지금은 딱 하나면 돼요 — 아래 📷 로 오늘 만드신 요리 사진을 올리고 “이거 올려줘”라고 말씀만 해주세요. 소개글 쓰고 예쁘게 올리는 건 제가 다 알아서 할게요.\n\n재료가 얼마 들었는지 같은 건 지금은 신경 안 쓰셔도 돼요. 어떤 요리들을 만들어 오셨는지 보여주기만 하면 충분하답니다. 나머지는 제가 챙길게요 :)"
  );
  addChips([
    "오늘 만든 요리 올리기 (사진은 📷)",
    "뭘 할 수 있는지 알려줘",
