...
function greet() {
  addBubble(
    "jarvis",
    "안녕하세요 사장님! 저는 홈페이지를 대신 관리해 드리는 비서예요.\n\n여기는 사장님이 직접 만든 요리와, 그날 산 재료·가격을 하나씩 기록해 두는 공간이에요. 이렇게 쌓인 기록이 나중에 큰 자료가 된답니다.\n\n제일 쉬운 시작은 이거예요 — 아래 📷 로 오늘 만든 요리 사진을 올리고 “이거 올려줘”라고 말씀만 해주세요. 그럼 제가 소개글을 써서 올리고, 재료값도 여쭤봐서 같이 기록해 둘게요."
  );
  addChips([
    "오늘 만든 요리 올리기 (사진은 📷)",
    "재료를 얼마에 샀는지 기록하기",
